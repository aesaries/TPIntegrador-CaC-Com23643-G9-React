...
export const Formulario = () => {
    ...
    <form className="mi-formulario  justify-content-center" onSubmit={handleSubmit(onSubmit)}>
        <div className="form-group">
            ...
            <input type="text" className="form-control" id="nombre" placeholder="Name" {...register('nombre', { required: true, maxLength: 10 })} />
        ...
        <div className="form-group">
            ...
            <input type="text" placeholder="Email" className="form-control" id="email" {...register('email', { pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/i })} />
            {errors.email?.type === 'pattern' && <small className="text-danger">El formato del email es incorrecto</small>}
        </div>

        <div className="form-group">
            <label htmlFor="edad">Edad</label>
            <input type="text" placeholder="Age" className="form-control" id="edad" {...register('edad', { validate: edadValidator })} />
        ...
        {incluirTelefono && (
            <div className="form-group">
                ...
                <input type="text" placeholder="Fone" className="form-control" id="telefono" {...register('telefono')} />
            </div>
        )}
